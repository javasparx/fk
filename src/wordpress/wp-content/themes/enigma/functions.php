...
function weblizar_default_settings() {
	...
	$wl_theme_options = array(
		...
		'instagram'                          => "#",
		'gplus'                              => "#",
		'email_id'                           => 'javasparx@gmail.com',
		'phone_no'                           => '(+998) 93 644 63 63',
		'footer_customizations'              => __( ' &#169; 2015 Services of Qualified Laboratory', 'weblizar' ),
		'developed_by_text'                  => __( 'Theme Developed By', 'weblizar' ),
		'developed_by_weblizar_text'         => __( 'Javlon Eraliyev', 'weblizar' ),
		'developed_by_link'                  => 'http://sql.uz/',
