...
<?php if ( have_comments() ) : ?>
	<div class="enigma_comment_section">
		<div class="enigma_comment_title"><h3><i
					class="fa fa-comments"></i><?php echo comments_number( __( 'No Comments', 'weblizar' ), __( '1 Comment', 'weblizar' ), '% Comments' ); ?>
			</h3></div>
		...
		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : ?>
			<nav id="comment-nav-below">
				...
				<div
					class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'weblizar' ) ); ?></div>
