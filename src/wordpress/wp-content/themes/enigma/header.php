					...
					<div class="col-md-6 col-sm-12">
						<div claSS="logo">
							<a href="<?php echo home_url( '/' ); ?>"
							   title="<?php echo esc_attr( get_bloginfo( 'description', 'display' ) ); ?>" rel="home">
								<?php
								...
								if ( $wl_theme_options['text_title'] == "on" ) {
									...
									<img class="img-responsive"
									     src="<?php echo $wl_theme_options['upload_image_logo']; ?>"
								...
								<?php } else {
									echo __( 'Enigma', 'weblizar' );
								}

								?>
							</a>

							<p class="shrink"><?php bloginfo( 'description' ); ?></p>
						</div>
					</div>
						...
						<div class="col-md-6 col-sm-12">
							...
							<ul class="social shrink">
								...
								if ( $wl_theme_options['linkedin_link'] != '' ) { ?>
									<li class="linkedin" data-toggle="tooltip" data-placement="bottom" title="Linkedin">
										<a
